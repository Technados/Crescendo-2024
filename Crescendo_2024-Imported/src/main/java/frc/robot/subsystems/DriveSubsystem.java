...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    // it is recommended to configure AutoBuilder at the end of your drive subsystem's constructor
  ...
  public void driveRobotRelative(ChassisSpeeds speeds) {
    drive(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond, speeds.omegaRadiansPerSecond, false, false); // set rate limiting to false for PathPlanner because it applies acceleration constraints.
  }
